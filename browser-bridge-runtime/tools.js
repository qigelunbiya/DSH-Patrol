  ...
  const definitions = [
    ...
    defineTool({
      ...
      parameters: {
        ...
        captureClientLeft: optNum, captureClientTop: optNum, captureWidth: optNum, captureHeight: optNum, captureMode: optStr, targetPixelWidth: optNum, captureDevicePixelRatio: optNum,
      ...
      output: {
        schema: {
          ...
          properties: {
            ...
            requestedClickX: optNum, requestedClickY: optNum, resolvedClickX: optNum, resolvedClickY: optNum, visualSnapped: bool, snapDistance: optNum, cdpPiercedTarget: bool, cdpPiercedActivator: bool, cdpPiercedFollowupEditor: bool, cdpPiercedAction: bool,
          },
        },
      ...
      execute: async (args, exec) => {
        ...
        return clean({
          ...
          captureWidth: value.captureWidth, captureHeight: value.captureHeight, captureMode: value.captureMode, targetPixelWidth: value.targetPixelWidth, captureDevicePixelRatio: value.captureDevicePixelRatio,
