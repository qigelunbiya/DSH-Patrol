...
export const DESKTOP_ACTIONS = [
  ...
  'click-target',
  'click-ocr-text',
  'click-visual-candidate',
  'click-focused-visual-point',
...
export const DESKTOP_ACTION_TOOL: Record<DesktopAction, ReplayableDesktopTool> = {
  ...
  'click-visual-candidate': 'desktop_click_visual_candidate',
  'click-focused-visual-point': 'desktop_click_focused_visual_point',
  'click-visual-template': 'desktop_click_visual_template',
