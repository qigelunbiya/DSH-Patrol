...
- 浏览器视觉规则只记一条：文字 → OCR bbox center；无文字 → clean CURRENT screenshot → browser V# Action Map → V# bbox center。模型不提交最终坐标。旧 A#/B#/focused/manual-coordinate 仅历史兼容；Browser 与 Desktop visual state 必须隔离。
